//#region node_modules/quill-task-list/task_list.js
var List = Quill.import("formats/list");
var ListItem = Quill.import("formats/list/item");
var Parchment = Quill.import("parchment");
var Module = Quill.import("core/module");
var Delta = Quill.import("delta");
var TaskListItem = class extends ListItem {
	format(name, value) {
		if (name === TaskList.blotName && !value) this.replaceWith(Parchment.create(this.statics.scope));
...
var TaskList = class extends List {
	static create(value) {
...
var TaskListModule = class extends Module {
...
//#endregion
//# sourceMappingURL=task_list-BjNJxjtx.js.map