import { $ as z, B as Y, D, F as S, G as bt, V as Yt, Z as v, a as x, et as f, t as BaseStyle, y as m } from "./style-BYoiNJMz.js";
import "./eventbus-DQYzpmdU.js";
import { t as script$2 } from "./basecomponent-P_OBUh03.js";
import { A as Fragment, G as createElementBlock, Gt as renderList, H as createBaseVNode, Jt as resolveDirective, Kt as renderSlot, Q as createVNode, Tt as mergeProps, U as createBlock, W as createCommentVNode, Yt as resolveDynamicComponent, Z as createTextVNode, n as Transition, or as toDisplayString, qt as resolveComponent, rr as normalizeClass, xn as withDirectives, yn as withCtx, zt as openBlock } from "./vue.runtime.esm-bundler-x0rhdbcL.js";
import "./service-ToW7vwlV.js";
import "./basedirective-rlU1qeJa.js";
import { t as Ripple } from "./ripple-BH4kwAyu.js";
import { n as ConnectedOverlayScrollHandler, t as OverlayEventBus } from "./overlayeventbus-7F1JbN2o.js";
import { t as script$1 } from "./portal-Bk12xjnt.js";

//#region node_modules/@primeuix/styles/dist/menu/index.mjs
...
var MenuStyle = BaseStyle.extend({
	...
	classes: {
		root: function root(_ref) {
			...
			return ["p-menu p-component", { "p-menu-overlay": props.popup }];
		},
		start: "p-menu-start",
		list: "p-menu-list",
...
//#endregion
//#region node_modules/primevue/menu/index.mjs
var script$2$1 = {
	name: "BaseMenu",
	"extends": script$2,
	props: {
	...
	methods: {
		...
		getMenuItemProps: function getMenuItemProps(item) {
			return {
				...
				icon: mergeProps({ "class": [this.cx("itemIcon"), item.icon] }, this.getPTOptions("itemIcon")),
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return $options.visible() ? (openBlock(), createElementBlock("li", mergeProps({
		...
		"label",
		"props"
	])) : createCommentVNode("", true)], 16, _hoisted_2$1)], 16, _hoisted_1$1)) : createCommentVNode("", true);
}
...
var script = {
	...
	methods: {
		itemClick: function itemClick(event) {
			...
			if (!this.popup && this.focusedOptionIndex !== event.id) this.focusedOptionIndex = event.id;
		},
		...
		findNextOptionIndex: function findNextOptionIndex(index) {
			var matchedOptionIndex = _toConsumableArray(Y(this.container, "li[data-pc-section=\"item\"][data-p-disabled=\"false\"]")).findIndex(function(link) {
		...
		alignOverlay: function alignOverlay() {
			...
			if (v(this.target) > v(this.container)) this.container.style.minWidth = v(this.target) + "px";
		},
		bindOutsideClickListener: function bindOutsideClickListener() {
			...
			if (!this.outsideClickListener) {
				this.outsideClickListener = function(event) {
					...
					else if (!_this.popup && isOutsideContainer && isOutsideTarget) _this.focusedOptionIndex = -1;
				};
		...
		bindResizeListener: function bindResizeListener() {
			...
			if (!this.resizeListener) {
				this.resizeListener = function() {
					if (_this3.overlayVisible && !Yt()) _this3.hide();
				};
				...
				"default": withCtx(function() {
					return [(_ctx.popup ? $data.overlayVisible : true) ? (openBlock(), createElementBlock("div", mergeProps({
						...
						createBaseVNode("ul", mergeProps({
							...
							return openBlock(), createElementBlock(Fragment, { key: $options.label(item) + i.toString() }, [item.items && $options.visible(item) && !item.separator ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [item.items ? (openBlock(), createElementBlock("li", mergeProps({
								key: 0,
								id: _ctx.$id + "_" + i,
								"class": [_ctx.cx("submenuLabel"), item["class"]],
								role: "none"
							}, { ref_for: true }, _ctx.ptm("submenuLabel")), [renderSlot(_ctx.$slots, _ctx.$slots.submenulabel ? "submenulabel" : "submenuheader", { item }, function() {
								...
								return openBlock(), createElementBlock(Fragment, { key: child.label + i + "_" + j }, [$options.visible(child) && !child.separator ? (openBlock(), createBlock(_component_PVMenuitem, {
									key: 0,
									id: _ctx.$id + "_" + i + "_" + j,
									item: child,
									...
									"onItemMousemove",
									"pt"
								])) : $options.visible(child) && child.separator ? (openBlock(), createElementBlock("li", mergeProps({
									key: "separator" + i + j,
									"class": [_ctx.cx("separator"), item["class"]],
									style: child.style,
									role: "separator"
								}, { ref_for: true }, _ctx.ptm("separator")), null, 16)) : createCommentVNode("", true)], 64);
							}), 128))], 64)) : $options.visible(item) && item.separator ? (openBlock(), createElementBlock("li", mergeProps({
								key: "separator" + i.toString(),
								"class": [_ctx.cx("separator"), item["class"]],
								style: item.style,
								role: "separator"
							}, { ref_for: true }, _ctx.ptm("separator")), null, 16)) : (openBlock(), createBlock(_component_PVMenuitem, {
