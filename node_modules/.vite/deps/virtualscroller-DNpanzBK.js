import { H as et, M as Rt, P as Tt, q as z, t as BaseStyle } from "./style-Dubd8-h0.js";
import { t as script$1 } from "./basecomponent-CKTIZI5G.js";
import { A as Fragment, G as createElementBlock, Gt as renderList, H as createBaseVNode, Kt as renderSlot, Q as createVNode, Tt as mergeProps, W as createCommentVNode, qt as resolveComponent, zt as openBlock } from "./vue.runtime.esm-bundler-x0rhdbcL.js";
import { t as script } from "./spinner-BZ-3YcyO.js";
...
var script$2 = {
	...
	methods: {
		...
		getContentPosition: function getContentPosition() {
			if (this.content) {
				var style$1 = getComputedStyle(this.content);
				var left = parseFloat(style$1.paddingLeft) + Math.max(parseFloat(style$1.left) || 0, 0);
				var right = parseFloat(style$1.paddingRight) + Math.max(parseFloat(style$1.right) || 0, 0);
				var top = parseFloat(style$1.paddingTop) + Math.max(parseFloat(style$1.top) || 0, 0);
				var bottom = parseFloat(style$1.paddingBottom) + Math.max(parseFloat(style$1.bottom) || 0, 0);
				return {
					left,
					right,
					top,
		...
		setContentPosition: function setContentPosition(pos) {
			...
			if (this.content && !this.appendOnly) {
				...
				var setTransform = function setTransform$1() {
					...
					return _this7.contentStyle = _objectSpread(_objectSpread({}, _this7.contentStyle), { transform: "translate3d(".concat(_x, "px, ").concat(_y, "px, 0)") });
				};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	], 16, _hoisted_1)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [renderSlot(_ctx.$slots, "default"), renderSlot(_ctx.$slots, "content", {
		items: _ctx.items,
		rows: _ctx.items,
		columns: $options.loadedColumns
	})], 64));
...
//#endregion
export { script$2 as t };
//# sourceMappingURL=virtualscroller-DNpanzBK.js.map